...
export const PARTIES: PartyInfo[] = [
  { slug: "union", shortcut: "CDU/CSU", name: "CDU/CSU", aliases: ["CDU/CSU", "CDU", "CSU"], wikipedia: `${WP}CDU/CSU` },
  { slug: "spd", shortcut: "SPD", name: "SPD", aliases: ["SPD"], wikipedia: `${WP}Sozialdemokratische_Partei_Deutschlands` },
  { slug: "gruene", shortcut: "Grüne", name: "Bündnis 90/Die Grünen", aliases: ["Grüne", "Bündnis 90/Die Grünen"], wikipedia: `${WP}B%C3%BCndnis_90/Die_Gr%C3%BCnen` },
  { slug: "afd", shortcut: "AfD", name: "AfD", aliases: ["AfD"], wikipedia: `${WP}Alternative_f%C3%BCr_Deutschland` },
  { slug: "linke", shortcut: "Linke", name: "Die Linke", aliases: ["Linke", "Die Linke"], wikipedia: `${WP}Die_Linke` },
  { slug: "bsw", shortcut: "BSW", name: "Bündnis Sahra Wagenknecht", aliases: ["BSW"], wikipedia: `${WP}B%C3%BCndnis_Sahra_Wagenknecht` },
  { slug: "fdp", shortcut: "FDP", name: "FDP", aliases: ["FDP"], wikipedia: `${WP}Freie_Demokratische_Partei` },
  { slug: "freie-waehler", shortcut: "FW", name: "Freie Wähler", aliases: ["FW", "Freie Wähler"], wikipedia: `${WP}Freie_W%C3%A4hler` },
];
